...
$query1="SELECT * FROM `houses` WHERE `status`<>'in_use'";
...
<p>
<a class="btn btn-success" href="house-detail.php?view=<?php echo $data1['id']; ?>">View</a><a class="btn btn-warning" href="index.php?cart=<?php echo $data1['id']; ?>">Add to Cart</a></p>
</div>
</div>
<?php  
       }
